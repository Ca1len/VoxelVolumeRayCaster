...
SphereVolume::SphereVolume(size_t IDimension, size_t JDimension,
                           ...
                           float ball_value)
    : VoxelVolume(IDimension, JDimension, KDimension), ball_center_(ballCenter),
      radius_(radius), ball_value_(ball_value) {
  ...
  cv::Matx44f ijk_translation = {1, 0, 0, (float)IDimension / 2, 0, 1, 0, (float)JDimension / 2,
